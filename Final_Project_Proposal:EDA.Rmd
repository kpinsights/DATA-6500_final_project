...
saveWidget(leaflet_map, "leaflet_map_with_inset.html", selfcontained = TRUE)

```


```{r printing static map, fig.cap = "Toronto Center Map with Traffic Signal locations, Traffic Congestion levels and Speed Limits."}
webshot("leaflet_map_with_inset.html",
        file = "Leaflet_map_with_inset.png", 
        cliprect = "viewport")
```
